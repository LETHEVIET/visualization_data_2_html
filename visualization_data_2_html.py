  ...
  def run(self):
    ...
    for i in tqdm(range(0, len(ls_img))):
      ...
      for x in f:
        ...
        x_min = (bouding_box_info[1] - bouding_box_info[3]/2) * width
        y_min = (bouding_box_info[2] - bouding_box_info[4]/2) * height
        x_max = (bouding_box_info[1] + bouding_box_info[3]/2) * width
        y_max = (bouding_box_info[2] + bouding_box_info[4]/2) * height
